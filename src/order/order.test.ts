...
describe('Order', () => {
  ...
  describe('Approve order', () => {
    ...
    it('approve MIT to ETP order', () => {
      expect(order.approve(wallet.getNode(bid_hd_wallet_path), bid_prev_out_script).toString()).to.equal('')
    })
  })
})